...
int main(){
	...
	int nilai; // input
	int total_lembar = 0; //total lembar duit yang kita miliki
	int seratus_ribu, lima_puluh_ribu, sepuluh_ribu, lima_ribu, seribu, lima_ratus, sepuluh, lima, satu = 0; // lembar per pecahannya
	
	
	cin >>nilai; // input duitnya
